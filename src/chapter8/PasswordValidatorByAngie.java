...
public class PasswordValidatorByAngie {
    ...
    public PasswordValidatorByAngie(String username, String currentPassword){
    ...
    public static PasswordValidatorByAngie login(){
        ...
        return new PasswordValidatorByAngie(username, password);
    }
